...
<select
    ...
    data-hs-select='{
        ...
        "mode": "tags",
        "wrapperClasses": "relative ps-0.5 pe-9 min-h-24 flex items-start flex-wrap text-nowrap w-full shadow-2xs border border-gray-200 rounded-lg text-start text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400",
        ...
        "tagsInputClasses": "py-2.5 sm:py-3 px-2 min-w-20 rounded-lg order-1 border-transparent focus:ring-0 sm:text-sm outline-hidden dark:bg-neutral-800 dark:placeholder-neutral-500 dark:text-neutral-400",
    ...
    @foreach($options as $option)
        <option
            ...
            data-hs-select-option='{
                ...
                "icon": "<img class=\"inline-block rounded-full\" src=\"{{ url('/storage/' . @$option['image']) }}\" />"
            }'
        >
            {{ $option['label'] }}
        </option>
